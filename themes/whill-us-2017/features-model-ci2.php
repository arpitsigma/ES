<?php
/**
 * Template Name: Features Model Ci2 Page
 *
 */
						...
						<?php else: ?>
							<div id="product-video-bg" style="background: url('<?php echo get_post_thumbnail_src( 'origin_size' ); ?>') center top no-repeat; background-size: cover;">
							  <div class="p-main-visual__video">
								<div class="player" data-property="{videoURL:'eXqpm2fH-20', containment:'.p-main-visual__video', autoPlay:true, loop:true, mute:true, startAt:0, opacity:1, showControls: false, showYTLogo: false, gaTrack: false, quality: 'highres'}"></div>
							  </div>
							</div>
							<?php if($hide == false):?><iframe id="product-video" src="https://www.youtube.com/embed/eXqpm2fH-20?enablejsapi=1&mute=1&autoplay=1&loop=1&controls=0&playlist=eXqpm2fH-20&disablekb=1&showinfo=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><?php endif; ?>
						<?php endif; ?>
							<div class="video-overlay intro-lg">
								<div class="overlay-content">
									<h1>Muévase más. Viva más.</h1>
									<span>Presentación del NUEVO</span>
									<p class="no-margin">WHILL Model C2</p>
								</div>
							</div>
							<div class="btn-movie-play-wrapper" style="display: none;">
						    <a href="https://www.youtube.com/watch?v=lyMy-f2yXrA" class="btn-movie-play vp-s" id="btn-maas-vision" data-yt="lyMy-f2yXrA"><div class="inner"></div></a>
							</div>
					</div>
